...
def generate_random_number(num_digits: int = 7) -> str:
...
def generate_input_output(num_haystack: int) -> tuple[str, list[str]]:
    keys, values, needles = [], [], []
...
def generate_samples(
    ...
    if args.type_haystack == "essay":
        incremental = 500
    elif args.type_haystack == "repeat" or args.type_haystack == "needle":
        incremental = 25
    ...
    while total_tokens + tokens_to_generate < max_seq_length:
        ...
        print(
            ...
            f"Current length {total_tokens + tokens_to_generate} | "
            f"Haystack: {num_haystack}"
        )
